                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://images.pexels.com/photos/1058423/pexels-photo-1058423.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
                                ...
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="text-gray-500">Legendary Lightning Yousuf </p>
                            </div>
                        </div>
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
