...
const KrishiUpchar = () => {
  return (
    <Layout>
      <div className="flex justify-center p-6 bg-green-50 text-green-900 font-sans">
        <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 border border-green-200">
          <h1 className="text-3xl font-bold text-green-700 mb-4">Common Rust of Corn</h1>

          {/* <p className="text-sm text-green-600 mb-6"><strong>Published:</strong> 03/19/2019</p> */}

          <h2 className="text-2xl font-semibold text-green-700 mb-2">Overview</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-green-700 mb-2">Symptoms</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-green-700 mb-2">Images</h2>
          <p className="mb-2"><strong>Pustules of common rust with brick-red spores.</strong></p>
          <img
          ...
          />
          <p className="mb-2"><strong>Common rust foliar symptoms.</strong></p>
          <img
            className="mb-4 rounded shadow-md w-full"
          ...
          <h2 className="text-2xl font-semibold text-green-700 mb-2">Disease Cycle</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-green-700 mb-2">Management</h2>
          <p className="mb-4">
            Resistant hybrids and inbreds are available. Foliar fungicides labeled for common rust are available.
          </p>

          <h2 className="text-2xl font-semibold text-green-700 mb-2">More Images</h2>
          <ul className="list-disc pl-6 mb-6 space-y-4">
            <li>Early development of common rust on corn leaf.
              <img
                className="mb-4 rounded shadow-md w-56"
            ...
            <li>Common rust pustules erupting with brick-red spores.
              <img
                className="mb-4 rounded shadow-md w-56"
            ...
            <li>Common rust pustules and surrounding dead leaf tissue.
              <img
                className="mb-4 rounded shadow-md w-56"
            ...
            <li>Severe common rust on corn leaf.
              <img
                className="mb-4 rounded shadow-md w-56"
            ...
            <li>Severe common rust infection on corn leaf.
              <img
                className="mb-4 rounded shadow-md w-56"
            ...
            <li>Common rust spores (bottom) are brick red, while southern rust spores (top) are more orange.
              <img
                className="mb-4 rounded shadow-md w-56"
